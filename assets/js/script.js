  ...
  if (!cityInput.value) {
    ...
    function weatherSearch() {
      ...
      .then(function(data2) {
        ...
        weatherIconEl.setAttribute("src","https://openweathermap.org/img/wn/" + data2.weather[0].icon + "@2x.png");
    ...
    function forecastSearch() {
      ...
      .then(function(data3) {
        ...
        for (i1 = 0; i1 < 4; i1++) {
          ...
          document.getElementById("forecastDay1.1WeatherIcon").setAttribute("src", "https://openweathermap.org/img/wn/" + data3.list[i1].weather[0].icon + "@2x.png");
        }
        for (j1 = 0; j1 < 7; j1++) {
        ...
        for (i2 = 0; i2 < 4; i2++) {
          ...
          document.getElementById("forecastDay1.2WeatherIcon").setAttribute("src", "https://openweathermap.org/img/wn/" + data3.list[i2].weather[0].icon + "@2x.png");
        }
        for (j2 = 0; j2 < 7; j2++) {
        ...
        for (i3 = 0; i3 < 4; i3++) {
          ...
          document.getElementById("forecastDay1.3WeatherIcon").setAttribute("src", "https://openweathermap.org/img/wn/" + data3.list[i3].weather[0].icon + "@2x.png");
        }
        for (j3 = 0; j3 < 7; j3++) {
        ...
        for (i4 = 0; i4 < 4; i4++) {
          ...
          document.getElementById("forecastDay1.4WeatherIcon").setAttribute("src", "https://openweathermap.org/img/wn/" + data3.list[i4].weather[0].icon + "@2x.png");
        }
        for (j4 = 0; j4< 7; j4++) {
        ...
        for (i5 = 0; i5 < 4; i5++) {
          ...
          document.getElementById("forecastDay1.5WeatherIcon").setAttribute("src", "https://openweathermap.org/img/wn/" + data3.list[i5].weather[0].icon + "@2x.png");
        }
        for (j5 = 0; j5< 7; j5++) {
        ...
        for (i6 = 0; i6 < 4; i6++) {
          ...
          document.getElementById("forecastDay1.6WeatherIcon").setAttribute("src", "https://openweathermap.org/img/wn/" + data3.list[i6].weather[0].icon + "@2x.png");
        }
        for (j6 = 0; j6< 7; j6++) {
        ...
        for (i7 = 0; i7 < 4; i7++) {
          ...
          document.getElementById("forecastDay1.7WeatherIcon").setAttribute("src", "https://openweathermap.org/img/wn/" + data3.list[i7].weather[0].icon + "@2x.png");
        }
        for (j7 = 0; j7< 7; j7++) {
        ...
        for (i8 = 0; i8 < 4; i8++) {
          ...
          document.getElementById("forecastDay1.8WeatherIcon").setAttribute("src", "https://openweathermap.org/img/wn/" + data3.list[i8].weather[0].icon + "@2x.png");
        }
        for (j8 = 0; j8< 7; j8++) {
        ...
        for (i9 = 0; i9 < 4; i9++) {
          ...
          document.getElementById("forecastDay2.1WeatherIcon").setAttribute("src", "https://openweathermap.org/img/wn/" + data3.list[i9].weather[0].icon + "@2x.png");
        }
        for (j9 = 0; j9< 7; j9++) {
        ...
        for (i10 = 0; i10 < 4; i10++) {
          ...
          document.getElementById("forecastDay2.2WeatherIcon").setAttribute("src", "https://openweathermap.org/img/wn/" + data3.list[i10].weather[0].icon + "@2x.png");
        }
        for (j10 = 0; j10< 7; j10++) {
        ...
        for (i11 = 0; i11 < 4; i11++) {
          ...
          document.getElementById("forecastDay2.3WeatherIcon").setAttribute("src", "https://openweathermap.org/img/wn/" + data3.list[i11].weather[0].icon + "@2x.png");
        }
        for (j11 = 0; j11< 7; j11++) {
        ...
        for (i12 = 0; i12 < 4; i12++) {
          ...
          document.getElementById("forecastDay2.4WeatherIcon").setAttribute("src", "https://openweathermap.org/img/wn/" + data3.list[i12].weather[0].icon + "@2x.png");
        }
        for (j12 = 0; j12< 7; j12++) {
        ...
        for (i13 = 0; i13 < 4; i13++) {
          ...
          document.getElementById("forecastDay2.5WeatherIcon").setAttribute("src", "https://openweathermap.org/img/wn/" + data3.list[i13].weather[0].icon + "@2x.png");
        }
        for (j13 = 0; j13< 7; j13++) {
        ...
        for (i14 = 0; i14 < 4; i14++) {
          ...
          document.getElementById("forecastDay2.6WeatherIcon").setAttribute("src", "https://openweathermap.org/img/wn/" + data3.list[i14].weather[0].icon + "@2x.png");
        }
        for (j14 = 0; j14< 7; j14++) {
        ...
        for (i15 = 0; i15 < 4; i15++) {
          ...
          document.getElementById("forecastDay2.7WeatherIcon").setAttribute("src", "https://openweathermap.org/img/wn/" + data3.list[i15].weather[0].icon + "@2x.png");
        }
        for (j15 = 0; j15< 7; j15++) {
        ...
        for (i16 = 0; i16 < 4; i16++) {
          ...
          document.getElementById("forecastDay2.8WeatherIcon").setAttribute("src", "https://openweathermap.org/img/wn/" + data3.list[i16].weather[0].icon + "@2x.png");
        }
        for (j16 = 0; j16< 7; j16++) {
        ...
        for (i17 = 0; i17 < 4; i17++) {
          ...
          document.getElementById("forecastDay3.1WeatherIcon").setAttribute("src", "https://openweathermap.org/img/wn/" + data3.list[i17].weather[0].icon + "@2x.png");
        }
        for (j17 = 0; j17< 7; j17++) {
        ...
        for (i18 = 0; i18 < 4; i18++) {
          ...
          document.getElementById("forecastDay3.2WeatherIcon").setAttribute("src", "https://openweathermap.org/img/wn/" + data3.list[i18].weather[0].icon + "@2x.png");
        }
        for (j18 = 0; j18< 7; j18++) {
        ...
        for (i19 = 0; i19 < 4; i19++) {
          ...
          document.getElementById("forecastDay3.3WeatherIcon").setAttribute("src", "https://openweathermap.org/img/wn/" + data3.list[i19].weather[0].icon + "@2x.png");
        }
        for (j19 = 0; j19< 7; j19++) {
        ...
        for (i20 = 0; i20 < 4; i20++) {
          ...
          document.getElementById("forecastDay3.4WeatherIcon").setAttribute("src", "https://openweathermap.org/img/wn/" + data3.list[i20].weather[0].icon + "@2x.png");
        }
        for (j20 = 0; j20< 7; j20++) {
        ...
        for (i21 = 0; i21 < 4; i21++) {
          ...
          document.getElementById("forecastDay3.5WeatherIcon").setAttribute("src", "https://openweathermap.org/img/wn/" + data3.list[i21].weather[0].icon + "@2x.png");
        }
        for (j21 = 0; j21< 7; j21++) {
        ...
        for (i22 = 0; i22 < 4; i22++) {
          ...
          document.getElementById("forecastDay3.6WeatherIcon").setAttribute("src", "https://openweathermap.org/img/wn/" + data3.list[i22].weather[0].icon + "@2x.png");
        }
        for (j22 = 0; j22< 7; j22++) {
        ...
        for (i23 = 0; i23 < 4; i23++) {
          ...
          document.getElementById("forecastDay3.7WeatherIcon").setAttribute("src", "https://openweathermap.org/img/wn/" + data3.list[i23].weather[0].icon + "@2x.png");
        }
        for (j23 = 0; j23< 7; j23++) {
        ...
        for (i24 = 0; i24 < 4; i24++) {
          ...
          document.getElementById("forecastDay3.8WeatherIcon").setAttribute("src", "https://openweathermap.org/img/wn/" + data3.list[i24].weather[0].icon + "@2x.png");
        }
        for (j24 = 0; j24< 7; j24++) {
        ...
        for (i25 = 0; i25 < 4; i25++) {
          ...
          document.getElementById("forecastDay4.1WeatherIcon").setAttribute("src", "https://openweathermap.org/img/wn/" + data3.list[i25].weather[0].icon + "@2x.png");
        }
        for (j25 = 0; j25< 7; j25++) {
        ...
        for (i26 = 0; i26 < 4; i26++) {
          ...
          document.getElementById("forecastDay4.2WeatherIcon").setAttribute("src", "https://openweathermap.org/img/wn/" + data3.list[i26].weather[0].icon + "@2x.png");
        }
        for (j26 = 0; j26< 7; j26++) {
        ...
        for (i27 = 0; i27 < 4; i27++) {
          ...
          document.getElementById("forecastDay4.3WeatherIcon").setAttribute("src", "https://openweathermap.org/img/wn/" + data3.list[i27].weather[0].icon + "@2x.png");
        }
        for (j27 = 0; j27< 7; j27++) {
        ...
        for (i28 = 0; i28 < 4; i28++) {
          ...
          document.getElementById("forecastDay4.4WeatherIcon").setAttribute("src", "https://openweathermap.org/img/wn/" + data3.list[i28].weather[0].icon + "@2x.png");
        }
        for (j28 = 0; j28< 7; j28++) {
        ...
        for (i29 = 0; i29 < 4; i29++) {
          ...
          document.getElementById("forecastDay4.5WeatherIcon").setAttribute("src", "https://openweathermap.org/img/wn/" + data3.list[i29].weather[0].icon + "@2x.png");
        }
        for (j29 = 0; j29< 7; j29++) {
        ...
        for (i30 = 0; i30 < 4; i30++) {
          ...
          document.getElementById("forecastDay4.6WeatherIcon").setAttribute("src", "https://openweathermap.org/img/wn/" + data3.list[i30].weather[0].icon + "@2x.png");
        }
        for (j30 = 0; j30< 7; j30++) {
        ...
        for (i31 = 0; i31 < 4; i31++) {
          ...
          document.getElementById("forecastDay4.7WeatherIcon").setAttribute("src", "https://openweathermap.org/img/wn/" + data3.list[i31].weather[0].icon + "@2x.png");
        }
        for (j31 = 0; j31< 7; j31++) {
        ...
        for (i32 = 0; i32 < 4; i32++) {
          ...
          document.getElementById("forecastDay4.8WeatherIcon").setAttribute("src", "https://openweathermap.org/img/wn/" + data3.list[i32].weather[0].icon + "@2x.png");
        }
        for (j32 = 0; j32 < 7; j32++) {
        ...
        for (i33 = 0; i33 < 4; i33++) {
          ...
          document.getElementById("forecastDay5.1WeatherIcon").setAttribute("src", "https://openweathermap.org/img/wn/" + data3.list[i33].weather[0].icon + "@2x.png");
        }
        for (j33 = 0; j33 < 7; j33++) {
        ...
        for (i34 = 0; i34 < 4; i34++) {
          ...
          document.getElementById("forecastDay5.2WeatherIcon").setAttribute("src", "https://openweathermap.org/img/wn/" + data3.list[i34].weather[0].icon + "@2x.png");
        }
        for (j34 = 0; j34 < 7; j34++) {
        ...
        for (i35 = 0; i35 < 4; i35++) {
          ...
          document.getElementById("forecastDay5.3WeatherIcon").setAttribute("src", "https://openweathermap.org/img/wn/" + data3.list[i35].weather[0].icon + "@2x.png");
        }
        for (j35 = 0; j35 < 7; j35++) {
        ...
        for (i36 = 0; i36 < 4; i36++) {
          ...
          document.getElementById("forecastDay5.4WeatherIcon").setAttribute("src", "https://openweathermap.org/img/wn/" + data3.list[i36].weather[0].icon + "@2x.png");
        }
        for (j36 = 0; j36 < 7; j36++) {
        ...
        for (i37 = 0; i37 < 4; i37++) {
          ...
          document.getElementById("forecastDay5.5WeatherIcon").setAttribute("src", "https://openweathermap.org/img/wn/" + data3.list[i37].weather[0].icon + "@2x.png");
        }
        for (j37 = 0; j37 < 7; j37++) {
        ...
        for (i38 = 0; i38 < 4; i38++) {
          ...
          document.getElementById("forecastDay5.6WeatherIcon").setAttribute("src", "https://openweathermap.org/img/wn/" + data3.list[i38].weather[0].icon + "@2x.png");
        }
        for (j38 = 0; j38 < 7; j38++) {
        ...
        for (i39 = 0; i39 < 4; i39++) {
          ...
          document.getElementById("forecastDay5.7WeatherIcon").setAttribute("src", "https://openweathermap.org/img/wn/" + data3.list[i39].weather[0].icon + "@2x.png");
        }
        for (j39 = 0; j39 < 7; j39++) {
        ...
        for (i40 = 0; i40 < 4; i40++) {
          ...
          document.getElementById("forecastDay5.8WeatherIcon").setAttribute("src", "https://openweathermap.org/img/wn/" + data3.list[i40].weather[0].icon + "@2x.png");
        }
        for (j40 = 0; j40 < 7; j40++) {
